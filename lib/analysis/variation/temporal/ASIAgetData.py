...
with open('/home/cwp/EMC/lib/analysis/variation/temporal/ASIAplotData.txt', 'w') as f:
    for item in plotData:
        f.write(','.join([str(x) for x in item]))
        f.write('\n')
    f.close()

with open('/home/cwp/EMC/lib/analysis/variation/temporal/ASIAplotTimes.txt', 'w') as f:
