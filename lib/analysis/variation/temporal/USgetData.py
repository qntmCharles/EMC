...
with open('/home/cwp/EMC/lib/analysis/variation/temporal/USplotData.txt', 'w') as f:
    for item in plotData:
        f.write(','.join([str(x) for x in item]))
        f.write('\n')
    f.close()

with open('/home/cwp/EMC/lib/analysis/variation/temporal/USplotTimes.txt', 'w') as f:
