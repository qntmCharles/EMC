...
with open('/home/cwp/EMC/lib/analysis/variation/temporal/TESTplotData.txt', 'r') as f:
    datas = f.readlines()
    for i in range(len(datas)):
        datas[i] = datas[i][:-1]

with open('/home/cwp/EMC/lib/analysis/variation/temporal/TESTplotTimes.txt', 'r') as f:
    times = f.readlines()
