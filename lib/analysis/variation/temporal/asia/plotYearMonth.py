...
plt.title('Detection count trend by year & month for Australian & Asian observers', y=1.05)
...
with open('/home/cwp/EMC/lib/analysis/variation/temporal/asia/YMplotData.txt', 'w') as f:
    for item in plotData:
        f.write(str(item))
        f.write('\n')
    f.close()

with open('/home/cwp/EMC/lib/analysis/variation/temporal/asia/YMplotTimes.txt', 'w') as f:
