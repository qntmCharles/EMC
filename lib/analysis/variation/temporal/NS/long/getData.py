...
filesPrelim = os.listdir('/home/cwp/EMC/lib/analysis/variation/temporal/NS/long/')
files = []
...
for filepath in files:
    ...
    with open(basedir+'/NS/long/'+filepath, 'r') as f:
...
for category, currentAuthors in allListedAuthors.items():
    ...
    with open(basedir+'NS/long/'+category+'DplotData.txt', 'w') as f:
        for item in DplotData:
            f.write(','.join([str(x) for x in item]))
            f.write('\n')
        f.close()

    with open(basedir+'NS/long/'+category+'DplotTimes.txt', 'w') as f:
    ...
    with open(basedir+'NS/long/'+category+'NplotData.txt', 'w') as f:
        for item in NplotData:
            f.write(','.join([str(x) for x in item]))
            f.write('\n')
        f.close()

    with open(basedir+'NS/long/'+category+'NplotTimes.txt', 'w') as f:
